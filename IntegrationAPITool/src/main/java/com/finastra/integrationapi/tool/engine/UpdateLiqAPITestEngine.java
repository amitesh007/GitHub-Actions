...
public enum UpdateLiqAPITestEngine {
    INSTANCE;

    public String getUpdateLiqAPITestClass(List<ExcelData> dataList, ExcelCommonData data, Boolean hasSoap){
        ...
        CommonTestUtility.INSTANCE.insertTestCreateIdempotency(builder, data, hasSoap);
        ...
        CommonTestUtility.INSTANCE.inserTestandOrder(builder, 16);
