...
public class LiqAPIDeleteLoanPrincipalPaymentIntegration extends LiqAPIExecutableData	implements IAPIRestIntegration , StObject {
	...
	public String securityAccessSymbol() {
		return DeleteLoanPrincipalPaymentIntegration;
	} 
	...
	public Object response() {
		Object object = LiqAPILoanPrincipalPaymentIntegrationAsReturnValue.clazz.forDelete(this.newLiqBusinessObject);
	...
	public static class Class extends LiqAPILiqAPIExecutableData.Class implements StClass {
		...
		public StObject basicNew() {
			return new LiqAPIDeleteLoanPrincipalPaymentIntegration();
		}

		public java.lang.Class getJavaClass() {
			return LiqAPIDeleteLoanPrincipalPaymentIntegration.class;
		}
